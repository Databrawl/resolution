...
export const OnboardingQuestion = ({
    ...
    return (
        <div
            ...
            className="cursor-pointer shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow bg-onboarding-yellow-bg px-3 py-0.5 rounded-xl border-black/10 dark:border-white/25 dark:text-black text-sm"
        >
            {question}
        </div>
    );
