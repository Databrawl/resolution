...
export const UseCaseComponent = ({
    ...
    return (
        <div className="flex flex-col gap-2 text-black">
            ...
            <div
                className="flex flex-col w-full shadow-md dark:shadow-primary/25 hover:shadow-xl transition-shadow rounded-xl bg-white dark:bg-black border border-black/10 dark:border-white/25 p-4 mt-10">
