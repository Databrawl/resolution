...
from typing import Callable, ClassVar, Dict, Generator, Iterator, List, Optional, Set, cast
...
from sqlalchemy.ext.declarative import as_declarative, DeclarativeMeta, DeferredReflection
...
class BaseModelMeta(DeclarativeMeta):
    ...
    def query(self) -> SearchQuery:
        if self._query is not None:
            ...
            raise NoSessionError("Can't get session. Please, call BaseModel.set_query() first")
...
class _Base:
    ...
    @classmethod
    def set_query(cls, query: SearchQuery) -> None:
        cls._query = query
...
class Database:
    ...
    def __init__(self, db_url: str) -> None:
        ...
        query = cast(SearchQuery, self.scoped_session.query_property())
        BaseModel.set_query(query)
